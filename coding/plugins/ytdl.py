...
async def download_video(event):
  ...
  if song:
      ...
      axv=await fast_upload(bot, f"{ytdl_data['id']}.mp3.mp3",reply=vtx, progress_bar_function=lambda d, t: asyncio.get_event_loop().create_task(progress(d, t, vtx, c_time, "uploading..", f"{ytdl_data['title']}.mp3.mp3")))  
